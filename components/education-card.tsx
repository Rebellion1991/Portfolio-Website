      ...
      <div className="md:flex">
        <div className="md:w-1/3 bg-primary/5 p-6 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">{education.degree}</h3>
        ...
        <div className="md:w-2/3 p-6">
          ...
          {education.description && <p className="mb-4 text-muted-foreground">{education.description}</p>}
