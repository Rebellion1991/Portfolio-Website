...
import { FormLabel, FormMessage, FormDescription, FormField } from "@/components/ui/form"
...
export function ContactForm() {
  const [formState, formAction] = useActionState(submitContactForm, { success: false })
      ...
      <form action={handleSubmit} className="space-y-6" noValidate>
        ...
        >
          <FormField>
            ...
            <FormDescription>Tell me about your project or inquiry in detail.</FormDescription>
            <Textarea
              id="message"
              name="message"
              ...
              rows={6}
              required
              className="rounded-lg border-2 focus:border-primary transition-colors resize-none"
              error={!!formState.errors?.message}
              aria-describedby={formState.errors?.message ? "message-error message-description" : "message-description"}
